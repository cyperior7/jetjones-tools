...
export const Top40Rankings: RankItem[] = [
    ...
    {name: "Stefon Diggs", position: Positions.WideReceiver},
    {name: "DeAndre Hopkins", position: Positions.WideReceiver},
    {name: "Calvin Ridley", position: Positions.WideReceiver},
    {name: "A.J. Brown", position: Positions.WideReceiver},
    {name: "D.K. Metcalf", position: Positions.WideReceiver},
    {name: "Najee Harris", position: Positions.RunningBack},
    {name: "Keenan Allen", position: Positions.WideReceiver},
    {name: "Joe Mixon", position: Positions.RunningBack},
    {name: "Justin Jefferson", position: Positions.WideReceiver},
    ...
    {name: "Antonio Gibson", position: Positions.RunningBack},
    {name: "David Montgomery", position: Positions.RunningBack},
    {name: "Chris Godwin", position: Positions.WideReceiver},
    {name: "CeeDee Lamb", position: Positions.WideReceiver},
    {name: "George Kittle", position: Positions.TightEnd},
    {name: "Terry McLaurin", position: Positions.WideReceiver},
    {name: "Mike Evans", position: Positions.WideReceiver},
    {name: "Diontae Johnson", position: Positions.WideReceiver},
    {name: "Robert Woods", position: Positions.WideReceiver},
    {name: "Myles Gaskin", position: Positions.RunningBack},
    {name: "James Robinson", position: Positions.RunningBack},
...
export const Top10Quarterbacks: RankItem[] = [
    ...
    {name: "Justin Herbert", position: Positions.QuarterBack},
    {name: "Dak Prescott", position: Positions.QuarterBack},
    {name: "Ryan Tannehill", position: Positions.QuarterBack},
    {name: "Matthew Stafford", position: Positions.QuarterBack},
];
...
export const Top10TightEnds: RankItem[] = [
    ...
    {name: "Kyle Pitts", position: Positions.TightEnd},
    {name: "T.J. Hockenson", position: Positions.TightEnd},
    {name: "Logan Thomas", position: Positions.TightEnd},
    {name: "Robert Tonyan", position: Positions.TightEnd},
    {name: "Jonnu Smith", position: Positions.TightEnd},
    {name: "Irv Smith Jr.", position: Positions.TightEnd},
];

export const Top10Defenses: RankItem[] = [
    {name: "Streaming", position: Positions.Defense},
];
...
export const Top10Kickers: RankItem[] = [
    ...
    {name: "Younghoe Koo", position: Positions.Kicker},
    {name: "Greg Zuerlein", position: Positions.Kicker},
    {name: "Ryan Succop", position: Positions.Kicker},
    {name: "Jason Sanders", position: Positions.Kicker},
    {name: "Tyler Bass", position: Positions.Kicker},
    {name: "Rodrigo Blankenship", position: Positions.Kicker},
